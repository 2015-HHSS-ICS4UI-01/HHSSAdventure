...
public class Interface extends javax.swing.JFrame {
    ...
    /**
     * To set the text on the interface for the current location
     * @param name The name of the location that the player is at
     */
     ...
     /**
      * To set the text on the interface for the current direction
...
/**
 * Calls HHSSAdventure to use the correct method for the action that was preformed
